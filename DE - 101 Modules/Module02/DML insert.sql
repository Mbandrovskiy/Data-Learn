...
-- внесение данных в таблицу module2.shipping_dim - внесено 4 строки
...
-- внесение данных в таблицу module2.segment_dim  -- внесено 3 строки
...
-- внесение данных в таблицу module2.returned_dim  -- внесено 296 строки
...
-- внесение данных в таблицу module2.product_dim  -- внесено 1 894 строки
...
-- внесение данных в таблицу module2.location_dim -- внесено 632 строки
...
-- внесение данных в таблицу module2.customer_dim -- внесено 793 строки
...
-- внесение данных в таблицу module2.calendar_dim -- внесено 3 472 строки
...
-- внесение данных в таблицу module2.sales_fact -- внесено 9 994 строки
